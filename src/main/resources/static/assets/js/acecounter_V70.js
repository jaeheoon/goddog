...
if (!_IDV(_GUL))
    var _GUL = 'weblog.knps.or.kr';
if (!_IDV(_GPT))
    var _GPT = '80';
var _d = _rf = _fwd = _arg = _xrg = _av = _bv = _rl = _ak = _xrl = _cd = _cu = _bz = ''
  , _sv = 11
  , _tz = 20
...
if (_ro.toSource || (_bI && _ro.shift))
    _sv = 13;
if (top && typeof top == 'object' && _IL(top.frames)) {
...
;if (_frm) {
    ...
    ;if (_rf == _prl) {
        ...
        ;if (document.URL.indexOf('?') > 0 && (_IX(_ak, 'rcsite=') < 0 && _IX(_ak, 'NVAR=') < 0 && _IX(_ak, 'src=') < 0 && _IX(_ak, 'source=') < 0))
    ...
    var p = {
        ...
        xL: function(x) {
            if (typeof (Amz_T_e) == s.u) {
                p.ol.src = p.p + p.s + '&url=' + escape(p.u()) + '&xlnk=' + escape(x) + '&xidx=0&';
                ssn.m.push(p.ol);
            }
        },
        xF: function(x) {
        ...
        lc: function(o) {
            try {
                ...
                if ((f.d(o.tagName) == 'IMG') && (typeof o.onclick == s.f)) {
                    tf = 1;
                    ar = String(o.onclick) + f.tt(obj);
                } else if (eval(s.Lp)) {
                    obj = f.f(o);
                    if (typeof obj.onclick == s.f) {
                        tf = 1;
                        ar = String(obj.onclick) + f.tt(obj);
                    } else if (typeof obj != s.n) {
                        tf = 0;
                        ar = String(obj.href) + f.tt(obj);
                    }
                    ;
                }
                if (ar.length == 0) {
